...
const Header = () => {
  ...
  window.addEventListener("scroll", function () {
    ...
    // when the scroll is higherthan 200 viewport height, add the scroll-header class to a tagwith the header tag
        ...
        <div className={`nav__menu ${Toggle ? "show-menu" : ""}`}>
          <ul className="nav__list grid">
            ...
            <li className="nav__item">
              ...
              >
                <i className="uil uil-user nav__icon"></i> Acerda de
              </a>
            </li>
